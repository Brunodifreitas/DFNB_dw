...
-----   ----------   -----------   -------------------------------------------------------------------------------
1.1     01/31/2020   BRUNOFREITAS  1. Built this table for LDS BC IT243
RUNTIME: 
Approx. 0 sec
NOTES:
This is an example of how to create a custom property named MS_Description which is widely used to
